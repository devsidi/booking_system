                          ...
                          <nav id="main-menu-navigation" class="navigation-main">
                              ...
                              @if (auth()->check()&& auth()->user()->role->name === 'admin')
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="{{ route('create-Car.create') }}" class="menu-item">Create Car</a>
                                        <a href="{{ route('MeetingRoom') }}" class="menu-item">Create Meeting Room</a>
                                    </div>
                                </div>
                              @endif
                              @if (auth()->check()&& auth()->user()->role->name === 'admin')
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                      <a href="{{ route('today.index') }}" class="menu-item">List of Request Car</a>
                                      <a href="{{ route('allCar.index') }}" class="menu-item">All Car</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class='fas fa-chalkboard-teacher'></i><span>Meeting Room</span></a>
                                    <div class="submenu-content">
                                        <a href="{{ route('today-room.index') }}" class="menu-item">List of Request Meeting Room</a>
                                        <a href="{{ route('allMeetingRoom.index') }}" class="menu-item">All Room</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class='ik ik-box'></i><span>Admin self-booking</span></a>
                                    <div class="submenu-content">
                                        <a href="{{ url('/dashboard/home') }}" class="menu-item">Booking</a> 
                                    </div>
                                </div>
                              @endif
